...
from .models import User, Tokens, Auth , Level, Blocked_Friend , Invitation , Conversation, Message, Friend, Match , Notification, MatchInvitation
...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('email', 'username', 'is_admin', 'is_online')
    fieldsets = (
        (None, {'fields': ('email', 'password')}),
        ('Personal info', {'fields': ('username', 'is_online')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('username', 'email', 'password', 'retype_password', 'is_online'),
        }),
    )
